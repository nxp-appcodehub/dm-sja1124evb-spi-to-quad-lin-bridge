 ...
 * Variables
 ******************************************************************************/
ARM_DRIVER_GPIO *pDspiGpioDriver = &Driver_GPIO_PORTD;
...
void register_spi_control(spiControlParams_t *ssControl)
{
	...
	{
		pDspiGpioDriver->SetOutput(ssControl->pTargetSlavePinID,1);
	}
	else
	{
		pDspiGpioDriver->SetOutput(ssControl->pTargetSlavePinID,0);
	}
}
