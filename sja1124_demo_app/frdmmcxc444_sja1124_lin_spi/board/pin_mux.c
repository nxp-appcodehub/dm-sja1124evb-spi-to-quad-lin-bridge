...
void SPI1_InitPins(void)
{
	...
	PORT_SetPinMux(PORTD, 4U, kPORT_MuxAsGpio); // ALT1 = PTD4

	/* PORTD5 (pin 62) is configured as SPI1_SCK */
	PORT_SetPinMux(PORTD, 5U, kPORT_MuxAlt2); // ALT2 = SPI1_SCK

	/* PORTD6 (pin 63) is configured as SPI1_MOSI */
	PORT_SetPinMux(PORTD, 6U, kPORT_MuxAlt2); // ALT2 = SPI1_MOSI

	/* PORTD7 (pin 64) is configured as SPI1_MISO */
	PORT_SetPinMux(PORTD, 7U, kPORT_MuxAlt2); // ALT2 = SPI1_MISO
}
...
void SPI1_DeinitPins(void)
{
	...
	PORT_SetPinMux(PORTD, 4U, kPORT_PinDisabledOrAnalog); // D10

	/* PORTD5 (pin 62) is configured as LCD_P45 */
	PORT_SetPinMux(PORTD, 5U, kPORT_PinDisabledOrAnalog); // D13

	/* PORTD6 (pin 63) is configured as LCD_P46 */
	PORT_SetPinMux(PORTD, 6U, kPORT_PinDisabledOrAnalog); // D11

	/* PORTD7 (pin 64) is configured as LCD_P47 */
	PORT_SetPinMux(PORTD, 7U, kPORT_PinDisabledOrAnalog); // D12
}
