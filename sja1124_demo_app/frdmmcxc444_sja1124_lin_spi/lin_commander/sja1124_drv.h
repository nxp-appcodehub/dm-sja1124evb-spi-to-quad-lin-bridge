...
/**
 * @brief        Start the PLL CLK for sja1124.
 *
 * @param[in]    freq                    frequency for TPM CLK generation.
 *
...
int32_t SJA1124_Start_Pll_Clk(uint32_t freq);

/**
 * @brief        Stop the TPM CLK for sja1124.
 *
 * @param[in]    :: None.
 *
 * @return       int32_t                 Return code.
