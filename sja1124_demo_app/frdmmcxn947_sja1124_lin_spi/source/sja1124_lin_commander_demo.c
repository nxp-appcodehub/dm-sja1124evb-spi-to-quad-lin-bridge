...
#define SJA1124_INT_ISR      GPIO00_IRQHandler

#define SJA1124_DEVICE	2
#define SJA_FRQ_KHZ		8000
...
static void checkLinWakeupRequest()
{
	...
	{
		SJA1124_DRV_DeviceInit(SJA1124_DEVICE, SJA_FRQ_KHZ, &deviceConfig, 0);
...
int main(void)
{
	...
	/* Get the PWM period match value and pulse width match value of 8000Khz PWM signal with 50% dutycycle */
	CTIMER_GetPwmPeriodValue(SJA_FRQ_HZ, CTIMER_DUTY_CYCLE, timerClock);
