...
gpioHandleKSDK_t D7 = {.base = GPIO0, .pinNumber = 14, .mask = 1 << (14), .clockName = kCLOCK_Gpio0, .portNumber = 0};

// gpioHandleKSDK_t D2 = {.base = GPIO0, .pinNumber = 29, .mask = 1 << (29), .clockName = kCLOCK_Gpio0, .portNumber = 0};

//GPIO Pin Handles
gpioHandleKSDK_t SJA1124_INT = {.base = GPIO0, .pinNumber = 29, .mask = 1 << (29), .irq = GPIO00_IRQn, .clockName = kCLOCK_Gpio0, .portNumber = 0};
