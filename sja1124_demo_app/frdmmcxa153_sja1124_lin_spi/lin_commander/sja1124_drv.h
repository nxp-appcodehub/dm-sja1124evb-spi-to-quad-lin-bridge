...
/**
 * @brief        Start the PWM for sja1124.
 *
 * @param[in]    freq                    frequency for PWM generation.
 * @param[in]    dutyCycle               duty cycle to generate PWM.
 *
 * @return       int32_t                 Return code.
 *
 * @api
 */
int32_t SJA1124_Start_Pwm(int32_t freq, int32_t dutyCycle);

/**
 * @brief        Stop the PWM for sja1124.
 *
 * @param[in]    :: None.
 *
 * @return       int32_t                 Return code.
 ...
 * @api
 */
int32_t SJA1124_Stop_Pwm();

/**
 * @brief        SJA1124 PWM initialization.
 *
 * @param[in]    freq 					 frequency for PWM generation.
 * @param[in]    dutyCycle               duty cycle for PWM initialization.
 *
 * @return       void                 Return code.
 *
 * @api
 */
void SJA1124_PWM_DRV_InitPwm(int freq, int dutyCycle);
